...
Executable creates a client that will connect a server and
	...
	2. send cyphertext and key
	3. recieve decoded plaintext from server and print to stdout
...
int main(int argc, char* argv[]) {
	...
	if (strcmp(buffer, "D") != 0) {fprintf(stderr, "Client: Handshake Error\n"); exit(1);};
	...
	if (strlen(key) < strlen(buffer)) error("Key too short");
